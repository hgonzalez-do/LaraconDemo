...
<style type="text/css">
    .lfMmzZ {
        padding: 128px 0px;
        background: url(/_next/static/media/hero-background.a7e6f59d.svg) center top / cover no-repeat, linear-gradient(rgb(20, 51, 214) 0%, rgb(0, 12, 121) 100%) center top / cover no-repeat;
    ...
    .bthkrS {
        color: rgb(255, 255, 255);
        filter: drop-shadow(rgba(255, 255, 255, 0.9) 0px 8px 20px);
        margin: 0px auto;
    }
