...
<nav class="w-full bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 shadow-sm mb-6">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            <!-- Logo / Brand -->
            <div id="logo "class="flex-shrink-0 flex items-center">
                <div aria-hidden="true" class="DigitalOceanStyles__StyledLogo-sc-cfc6b058-1 dbyTeA">
                    <a href="{{ url('/') }}">
                        <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 90 90" tabindex="-1"
                            class="DigitalOceanSmileyStyles__StyledSvg-sc-64ca7b97-4 dKkQH">
                            <circle cx="45" cy="45" r="36.25" fill="none" stroke="currentColor"
                                stroke-width="17.5" stroke-dasharray="170.824100538945 56.941366846315"
                                stroke-dashoffset="113.88273369263"
                                class="DigitalOceanSmileyStyles__StyledCircle-sc-64ca7b97-0 ffedqn"></circle>
                            <rect x="3.25" y="61.5" width="11" height="11" fill="currentColor"
                                class="DigitalOceanSmileyStyles__StyledPixelSm-sc-64ca7b97-1 iMTpXy"></rect>
                            <rect x="14.25" y="72.5" width="13.5" height="13.5" fill="currentColor"
                                class="DigitalOceanSmileyStyles__StyledPixelMd-sc-64ca7b97-2 iPjerR"></rect>
                            <rect x="27.5" y="55.25" width="17.25" height="17.25" fill="currentColor"
                                class="DigitalOceanSmileyStyles__StyledPixelLg-sc-64ca7b97-3 bImxhS"></rect>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" height="32" viewBox="32 0 159 32" fill="currentColor"
                            class="DigitalOceanStyles__StyledText-sc-cfc6b058-0 janZVK">
                            <path
                        ...
                        <span class="laracon2025">@ Laracon</span></a>
                </div>
            </div>
            <!-- Menu Links -->
            <div class="hidden md:flex space-x-8">
                ...
                <a href="{{ url('/gradient') }}"><img class="card-icon"
                        src="https://docs.digitalocean.com/images/icons/ml.svg" alt="Valkey"><span>Gradient</span></a>
            </div>
            <!-- Mobile menu button -->
            <div class="md:hidden flex items-center">
                <button id="mobile-menu-button"
                    class="text-gray-500 hover:text-[#F53003] focus:outline-none focus:text-[#F53003]">
    ...
    <div id="mobile-menu" class="md:hidden hidden px-20 bg-white">
        ...
        <a href="{{ url('/gradient') }}"><img class="card-icon" src="https://docs.digitalocean.com/images/icons/ml.svg"
                alt="Valkey"><span>Gradient</span></a>
    </div>
    <script>
