                ...
                <div class="text-[17px] leading-[20px] flex-1 p-6 pb-6 lg:p-10 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    ...
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        ...
                        <li class="flex items-center gap-4 py-2 relative">
                            ...
                            <span>
                                AI made incredibly simple with
                                <a href="https://docs.digitalocean.com/products/gradientai/" target="_blank" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#0061eb] dark:text-[#FF4433] ml-1">
                        ...
                        <li class="flex items-center gap-4 py-2 relative">
                            ...
                            <span>
                                Want more to take your Laravel deployment to the next level?
                                <a href="https://www.digitalocean.com/" target="_blank" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#0061eb] dark:text-[#FF4433] ml-1">
